...
public class MatrizDaoImpl extends GenericDaoImpl<Matriz> implements MatrizDao {
	...
	public Object getMatriz(Long idPersona) {
		String q="select ha.idhabilidades, c.descripcion as Competencia, ha.descripcion as habilidad, ot.descripcion as atributo, t.experiencia, t.certificado, m.idmatriz, c.idcompetencia, h.idhabilidad, t.idatributos "
