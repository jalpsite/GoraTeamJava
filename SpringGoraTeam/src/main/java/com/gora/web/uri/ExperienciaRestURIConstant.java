...
public class ExperienciaRestURIConstant {
    ...
    public static final String UPDATE_EXPERIENCIA = "/update/{idPersona}";
    public static final String UPDATESINGLE_EXPERIENCIA = "/updatesingle/{idPersona}";    
    public static final String DELETE_EXPERIENCIA = "/delete/{id}";        
}
